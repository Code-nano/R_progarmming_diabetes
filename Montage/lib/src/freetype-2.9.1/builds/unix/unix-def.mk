...
#
prefix       := /root/Montage/lib/src/freetype-2.9.1/../../freetype
exec_prefix  := ${prefix}
...
REQUIRES_PRIVATE   := harfbuzz >= 1.3.0
LIBS_PRIVATE       := -lbz2
LIBSSTATIC_CONFIG  := -lfreetype -lbz2 -lharfbuzz -lm -lglib-2.0 -pthread -lm -lpcre -lfreetype -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lgraphite2
build_libtool_libs := 
ft_version         := 22.1.16
